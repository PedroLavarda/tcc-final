...
# --- CONSTRUÇÃO DO MODELO (TRANSFER LEARNING COM RESNET101V2) ---
...
checkpoint = ModelCheckpoint("resnet_finetuningbalanced.h5", monitor="val_accuracy", save_best_only=True, mode="auto", verbose=1)
...
model.load_weights("resnet_finetuningbalanced.h5")
