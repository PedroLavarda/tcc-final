...
# --- MODIFICAÇÃO 2: Carregar o modelo base EfficientNetB5 pré-treinado ---
...
# --- MODIFICAÇÃO 3: Usar a normalização específica do EfficientNet ---
...
# Definir callbacks
# --- MODIFICAÇÃO 4: Atualizar o nome do arquivo do checkpoint ---
checkpoint = ModelCheckpoint("efficientnetb5_finetuning.h5", monitor="val_accuracy", save_best_only=True, mode="auto", verbose=1)
...
model.load_weights("efficientnetb5_finetuning.h5")
...
# Recomenda-se exibir o plot em ambientes interativos ou salvá-lo em um arquivo
# plt.show() 
# ou
# plt.savefig("confusion_matrix_efficientnetb5.png")
