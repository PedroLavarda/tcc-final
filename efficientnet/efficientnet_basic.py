...
checkpoint = ModelCheckpoint("efficientnetb5_basic.h5", monitor="val_accuracy", save_best_only=True, mode="auto", verbose=1)
...
model.load_weights("efficientnetb5_basic.h5")
...
base_filename = f"efficientnetb5_basic_{timestamp}"
